...
# C:\Python39\python.exe -m venv "${PLONE_HOME}"
...
# comement out the following line when the pull request has been accepted.
...
echo -E "TSTAMP_START=${TSTAMP_START}  TSTAMP_END=${TSTAMP_END}"
